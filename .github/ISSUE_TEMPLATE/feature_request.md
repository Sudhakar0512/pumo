...
1. This tracker should only be used to report bugs and request features / enhancements to Frappe
    ...
    - For documentation issues, use https://pumotechnovation.com/docs/user/en or the developer cheetsheet https://pumotechnovation.com/docs/user/en/bench/resources/bench-commands-cheatsheet
